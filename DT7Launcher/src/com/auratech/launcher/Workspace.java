...
import com.auratech.launcher.FolderIcon.FolderRingAnimator;
...
public class Workspace extends SmoothPagedView
    ...
    public long commitExtraEmptyScreen() {
        ...
        long newId = 0;
        try {
        	 newId = LauncherAppState.getLauncherProvider().generateNewScreenId();
	
        } catch (Exception e) {
	// TODO: handle exception
        	LauncherAppState.getLauncherProvider().initMaxScreenId();//micheal add when updata the mid and add the widget error
        	newId = LauncherAppState.getLauncherProvider().generateNewScreenId();
        }
