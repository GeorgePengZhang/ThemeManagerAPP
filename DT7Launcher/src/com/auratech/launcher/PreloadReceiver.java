...
import com.auratech.launcher.LauncherProvider;
...
public class PreloadReceiver extends BroadcastReceiver {
    ...
    public static final String EXTRA_WORKSPACE_NAME =
            "com.auratech.launcher.action.EXTRA_WORKSPACE_NAME";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (provider != null) {
            ...
            final int workspaceResId = !TextUtils.isEmpty(name)
                    ? context.getResources().getIdentifier(name, "xml", "com.auratech.launcher") : 0;
            if (LOGD) {
