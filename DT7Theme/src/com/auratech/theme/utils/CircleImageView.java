...
//    private float mDrawableRadius;
    ...
    public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mBorderRadius = a.getDimensionPixelSize(R.styleable.CircleImageView_border_radius, DEFAULT_BORDER_RADIUS);
...
//        mShaderMatrix.reset();
//        mShaderMatrix.setRectToRect(mDrawableRect, mBorderRect, Matrix.ScaleToFit.FILL);
