...
public class ThemeUtils {
	...
	public static final String THEME_TYPE_LIVEWALLPAPER 		= "livewallpaper/";
	public static final String THEME_TYPE_LIVEWALLPAPER_BG		= "bg/bg.png";
	public static final String THEME_TYPE_LIVEWALLPAPER_CONFIG  = "config.art";
